...
function Step3Report({report}) {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8){
      ...
      advice = 
        "Good foundation shown. Imporve clarity and structure. practice delivering concise, confident answers with stronger supporting examples.";
    } else {
      advice =
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          >
            ...
            <div className='mt-4'>
              <p className='font-semibold text-gay-800 text-sm sm:text-base'>
                {performaceText}
              </p>
                    ...
                    {questionWiseScore.map((q,i)=>(
                      <div key={i} className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200'>
                        ...
                        <div className='bg-green-50 border border-green-200 p-4 rounded-lg'>
                          <p className='text-xs text-green-600 font-semibold mb-l'>
                            AI Feedback
                          </p>
