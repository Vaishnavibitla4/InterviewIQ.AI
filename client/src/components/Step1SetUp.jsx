            ...
            <div className='space-y-5'>
              {
                [
                  {
                    icon: <FaUserTie className='text-green-600 text-xl'></FaUserTie>,
                    text: "Choose Role & Experience",
                  },
                  {
                    icon: <FaMicrophoneAlt className='text-green-600 text-xl'></FaMicrophoneAlt>,
                    text: "Smart Voice Interview",
                  },
                  {
                    icon: <FaChartLine className='text-green-600 text-xl'></FaChartLine>,
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            <div className='relative'>
                <FaUserTie className='absolute top-4 left-4 text-gray-400'></FaUserTie>
                <input 
            ...
            <div className='relative'>
                <FaBriefcase className='absolute top-4 left-4 text-gray-400'></FaBriefcase>
                <input 
             ...
             <select 
                ...
                {!analysisDone && (
                  ...
                  className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover:bg-green-50 transition'>
                      ...
                      <input 
                      type="file" accept="application/pdf" id="resumeUpload" className='hidden'
