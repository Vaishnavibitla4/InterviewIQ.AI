        ...
        const messages = [
            {
                ...
                3. Correctness - Is the answer accurate, relevamt, and complete?
                ...
                - 10 to 15 words only.
                - Sound like real interviwe feedback.
...
export const getInterviewReport = async (req,res) => {
    try{
        ...
        return res.status(500).json({message: `failed to find currentUser report ${error}`})
    }
}